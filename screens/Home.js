    ...
    <>
      ...
      >
        <Pressable onPress={()=>navigation.navigate("Search")}>
          ...
          >
            ...
            <Text
              style={{ height: 50, width: "90%", fontSize: 20,justifyContent:'center',color:'grey',marginTop:20 }}
      ...
      >
        <View style={{ flexDirection: "row" }}>
          <Text style={{ fontSize: 40, fontWeight: 600, color: COLOR }}>
            Booking
          </Text>
          <Text style={{ fontSize: 40, fontWeight: 600, color: "blue" }}>
            .com
          </Text>
        </View>
      </View>
          ...
          >
            <Pressable
              onPress={() => {
                setNumberOfPax({
                  ...numberOfPax,
                  ["children"]: numberOfPax.children + 1,
                });
              }}
            >
              <View
            ...
            <View>
              <Text>{numberOfPax.children}</Text>
            </View>
